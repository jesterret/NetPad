...
export interface IAppApiClient {
    ...
    openFolderContainingScript(scriptPath: string | undefined, signal?: AbortSignal | undefined): Promise<void>;
...
export class AppApiClient extends ApiClientBase implements IAppApiClient {
    ...
    getIdentifier(signal?: AbortSignal): Promise<AppIdentifier> {
    ...
    notifyClientAppIsReady(signal?: AbortSignal): Promise<void> {
    ...
    checkDependencies(signal?: AbortSignal): Promise<AppDependencyCheckResult> {
    ...
    protected processCheckDependencies(response: Response): Promise<AppDependencyCheckResult> {
        ...
        return Promise.resolve<AppDependencyCheckResult>(null as any);
    }

    openFolderContainingScript(scriptPath: string | undefined, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/app/open-folder-containing-script?";
        if (scriptPath === null)
            throw new Error("The parameter 'scriptPath' cannot be null.");
    ...
    openScriptsFolder(path: string | null | undefined, signal?: AbortSignal): Promise<void> {
    ...
    openPackageCacheFolder(signal?: AbortSignal): Promise<void> {
    ...
    getDotNetPathReport(signal?: AbortSignal): Promise<DotNetPathReport> {
    ...
    protected processGetDotNetPathReport(response: Response): Promise<DotNetPathReport> {
        ...
        return Promise.resolve<DotNetPathReport>(null as any);
    }

    sendRemoteLog(source: LogSource, logs: RemoteLogMessage[], signal?: AbortSignal): Promise<void> {
...
export class AssembliesApiClient extends ApiClientBase implements IAssembliesApiClient {
    ...
    getNamespaces(reference: Reference, signal?: AbortSignal): Promise<string[]> {
...
export class CodeApiClient extends ApiClientBase implements ICodeApiClient {
    ...
    getSyntaxTree(scriptId: string, signal?: AbortSignal): Promise<SyntaxNodeOrTokenSlim> {
...
export class DataConnectionsApiClient extends ApiClientBase implements IDataConnectionsApiClient {
    ...
    get(id: string, signal?: AbortSignal): Promise<DataConnection> {
    ...
    getAllNames(signal?: AbortSignal): Promise<string[]> {
    ...
    getConnectionString(dataConnection: DataConnection, signal?: AbortSignal): Promise<string> {
    ...
    test(dataConnection: DataConnection, signal?: AbortSignal): Promise<DataConnectionTestResult> {
    ...
    getDatabases(dataConnection: DataConnection, signal?: AbortSignal): Promise<string[]> {
    ...
    protected processGetDatabaseStructure(response: Response): Promise<DatabaseStructure> {
        ...
        return Promise.resolve<DatabaseStructure>(null as any);
    }

    scaffoldToProject(id: string, projectDirectoryPath: string | undefined, frameworkVersion: DotNetFrameworkVersion | undefined, signal?: AbortSignal): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/data-connections/{id}/scaffold-to-project?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (projectDirectoryPath === null)
            throw new Error("The parameter 'projectDirectoryPath' cannot be null.");
        else if (projectDirectoryPath !== undefined)
...
export interface IPackagesApiClient {
    ...
    deleteCachedPackage(packageId: string | undefined, packageVersion: string | undefined, signal?: AbortSignal | undefined): Promise<FileResponse | null>;
...
export class PackagesApiClient extends ApiClientBase implements IPackagesApiClient {
    ...
    getCachedPackages(loadMetadata: boolean | undefined, signal?: AbortSignal): Promise<CachedPackage[]> {
    ...
    protected processGetCachedPackages(response: Response): Promise<CachedPackage[]> {
        ...
        return Promise.resolve<CachedPackage[]>(null as any);
    }

    deleteCachedPackage(packageId: string | undefined, packageVersion: string | undefined, signal?: AbortSignal): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/packages/cache?";
        if (packageId === null)
        ...
        if (packageVersion === null)
            throw new Error("The parameter 'packageVersion' cannot be null.");
    ...
    getExplicitlyInstalledCachedPackages(loadMetadata: boolean | undefined, signal?: AbortSignal): Promise<CachedPackage[]> {
    ...
    purgePackageCache(signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    getPackageMetadata(packages: PackageIdentity[], signal?: AbortSignal): Promise<PackageMetadata[]> {
...
export interface IScriptsApiClient {
    ...
    dumpMemCacheItem(id: string, key: string | undefined, signal?: AbortSignal | undefined): Promise<void>;
...
export class ScriptsApiClient extends ApiClientBase implements IScriptsApiClient {
    ...
    getScripts(signal?: AbortSignal): Promise<ScriptSummary[]> {
    ...
    stopAll(force: boolean | undefined, signal?: AbortSignal): Promise<void> {
    ...
    openConfigWindow(id: string, tab: string | null | undefined, signal?: AbortSignal): Promise<void> {
    ...
    setScriptNamespaces(id: string, namespaces: string[], signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setReferences(id: string, newReferences: Reference[], signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setScriptKind(id: string, scriptKind: string, signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setTargetFrameworkVersion(id: string, targetFrameworkVersion: string, signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setOptimizationLevel(id: string, optimizationLevel: string, signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setUseAspNet(id: string, useAspNet: boolean, signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    setDataConnection(id: string, dataConnectionId: string | null | undefined, signal?: AbortSignal): Promise<FileResponse | null> {
    ...
    deleteMemCacheItem(id: string, key: string | undefined, signal?: AbortSignal): Promise<void> {
    ...
    clearMemCacheItems(id: string, signal?: AbortSignal): Promise<void> {
...
export class SessionApiClient extends ApiClientBase implements ISessionApiClient {
    ...
    getEnvironment(scriptId: string, signal?: AbortSignal): Promise<ScriptEnvironment> {
    ...
    getEnvironments(signal?: AbortSignal): Promise<ScriptEnvironment[]> {
    ...
    getActive(signal?: AbortSignal): Promise<string | null> {
...
export class SettingsApiClient extends ApiClientBase implements ISettingsApiClient {
    ...
    update(update: Settings, signal?: AbortSignal): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/settings";
        url_ = url_.replace(/[?&]$/, "");
    ...
    openSettingsWindow(tab: string | null | undefined, signal?: AbortSignal): Promise<void> {
    ...
    showSettingsFile(signal?: AbortSignal): Promise<FileResponse | null> {
...
export class WindowApiClient extends ApiClientBase implements IWindowApiClient {
    ...
    openOutputWindow(signal?: AbortSignal): Promise<void> {
    ...
    openCodeWindow(signal?: AbortSignal): Promise<void> {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.dotNetSdkVersions)) {
            ...
            for (let item of this.dotNetSdkVersions)
                data["dotNetSdkVersions"].push(item ? item.toJSON() : <any>undefined);
        }
        ...
        if (Array.isArray(this.supportedDotNetSdkVersionsInstalled)) {
            ...
            for (let item of this.supportedDotNetSdkVersionsInstalled)
                data["supportedDotNetSdkVersionsInstalled"].push(item ? item.toJSON() : <any>undefined);
        }
...
export class DirectoryPath extends AbsolutePath implements IDirectoryPath {
    ...
    static override fromJS(data: any): DirectoryPath {
        data = typeof data === 'object' ? data : {};
...
export class AssemblyFileReference extends Reference implements IAssemblyFileReference {
    ...
    static override fromJS(data: any): AssemblyFileReference {
        data = typeof data === 'object' ? data : {};
        let result = new AssemblyFileReference();
        result.init(data);
        return result;
...
export class AssemblyImageReference extends Reference implements IAssemblyImageReference {
    ...
    static override fromJS(data: any): AssemblyImageReference {
        data = typeof data === 'object' ? data : {};
        let result = new AssemblyImageReference();
        result.init(data);
        return result;
...
export class PackageReference extends Reference implements IPackageReference {
    ...
    static override fromJS(data: any): PackageReference {
        data = typeof data === 'object' ? data : {};
        let result = new PackageReference();
        result.init(data);
        return result;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.leadingTrivia)) {
            ...
            for (let item of this.leadingTrivia)
                data["leadingTrivia"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.trailingTrivia)) {
            data["trailingTrivia"] = [];
            for (let item of this.trailingTrivia)
                data["trailingTrivia"].push(item ? item.toJSON() : <any>undefined);
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.schemas)) {
            ...
            for (let item of this.schemas)
                data["schemas"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.tables)) {
            ...
            for (let item of this.tables)
                data["tables"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.indexes)) {
            ...
            for (let item of this.indexes)
                data["indexes"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.navigations)) {
            data["navigations"] = [];
            for (let item of this.navigations)
                data["navigations"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
...
export class CachedPackage extends PackageMetadata implements ICachedPackage {
    ...
    static override fromJS(data: any): CachedPackage {
        data = typeof data === 'object' ? data : {};
...
/** Represents the collection of package dependencies that are required when installing a parent package for a specific .NET target framework. */
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.shortcuts)) {
            ...
            for (let item of this.shortcuts)
                data["shortcuts"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
...
export class ScriptPropertyChangedEvent extends PropertyChangedEvent implements IScriptPropertyChangedEvent {
    ...
    static override fromJS(data: any): ScriptPropertyChangedEvent {
        data = typeof data === 'object' ? data : {};
...
export class ScriptConfigPropertyChangedEvent extends PropertyChangedEvent implements IScriptConfigPropertyChangedEvent {
    ...
    static override fromJS(data: any): ScriptConfigPropertyChangedEvent {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.environments)) {
            ...
            for (let item of this.environments)
                data["environments"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
...
export class EnvironmentPropertyChangedEvent extends PropertyChangedEvent implements IEnvironmentPropertyChangedEvent {
    ...
    static override fromJS(data: any): EnvironmentPropertyChangedEvent {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.scripts)) {
            ...
            for (let item of this.scripts)
                data["scripts"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
...
export abstract class Command extends CommandBase implements ICommand {
    ...
    static override fromJS(data: any): Command {
        data = typeof data === 'object' ? data : {};
...
export class OpenWindowCommand extends Command implements IOpenWindowCommand {
    ...
    static override fromJS(data: any): OpenWindowCommand {
        data = typeof data === 'object' ? data : {};
...
export abstract class CommandOfYesNoCancel extends CommandBase implements ICommandOfYesNoCancel {
    ...
    static override fromJS(data: any): CommandOfYesNoCancel {
        data = typeof data === 'object' ? data : {};
...
export class ConfirmSaveCommand extends CommandOfYesNoCancel implements IConfirmSaveCommand {
    ...
    static override fromJS(data: any): ConfirmSaveCommand {
        data = typeof data === 'object' ? data : {};
...
export abstract class CommandOfString extends CommandBase implements ICommandOfString {
    ...
    static override fromJS(data: any): CommandOfString {
        data = typeof data === 'object' ? data : {};
...
export class RequestScriptSavePathCommand extends CommandOfString implements IRequestScriptSavePathCommand {
    ...
    static override fromJS(data: any): RequestScriptSavePathCommand {
        data = typeof data === 'object' ? data : {};
...
export class AlertUserCommand extends Command implements IAlertUserCommand {
    ...
    static override fromJS(data: any): AlertUserCommand {
        data = typeof data === 'object' ? data : {};
...
export class ConfirmWithUserCommand extends CommandOfYesNoCancel implements IConfirmWithUserCommand {
    ...
    static override fromJS(data: any): ConfirmWithUserCommand {
        data = typeof data === 'object' ? data : {};
...
export class PromptUserCommand extends CommandOfString implements IPromptUserCommand {
    ...
    static override fromJS(data: any): PromptUserCommand {
        data = typeof data === 'object' ? data : {};
...
export class PromptUserForInputCommand extends CommandOfString implements IPromptUserForInputCommand {
    ...
    static override fromJS(data: any): PromptUserForInputCommand {
        data = typeof data === 'object' ? data : {};
...
export class AlertUserAboutMissingAppDependencies extends Command implements IAlertUserAboutMissingAppDependencies {
    ...
    static override fromJS(data: any): AlertUserAboutMissingAppDependencies {
        data = typeof data === 'object' ? data : {};
...
For example, if this value is Timeout=300:
  ...
  - When connection string is "Server=file.db;Password=123;" the resulting final
    ...
    static override fromJS(data: any): DatabaseConnection {
        data = typeof data === 'object' ? data : {};
        if (data["discriminator"] === "EntityFrameworkDatabaseConnection") {
            throw new Error("The abstract class 'EntityFrameworkDatabaseConnection' cannot be instantiated.");
        }
...
export class MsSqlServerDatabaseConnection extends EntityFrameworkDatabaseConnection implements IMsSqlServerDatabaseConnection {
    ...
    static override fromJS(data: any): MsSqlServerDatabaseConnection {
        data = typeof data === 'object' ? data : {};
        let result = new MsSqlServerDatabaseConnection();
        result.init(data);
        return result;
...
export class PostgreSqlDatabaseConnection extends EntityFrameworkDatabaseConnection implements IPostgreSqlDatabaseConnection {
    ...
    static override fromJS(data: any): PostgreSqlDatabaseConnection {
        data = typeof data === 'object' ? data : {};
        let result = new PostgreSqlDatabaseConnection();
        result.init(data);
        return result;
...
export class SQLiteDatabaseConnection extends EntityFrameworkDatabaseConnection implements ISQLiteDatabaseConnection {
    ...
    static override fromJS(data: any): SQLiteDatabaseConnection {
        data = typeof data === 'object' ? data : {};
        let result = new SQLiteDatabaseConnection();
        result.init(data);
        return result;
...
export class MySqlDatabaseConnection extends EntityFrameworkDatabaseConnection implements IMySqlDatabaseConnection {
    ...
    static override fromJS(data: any): MySqlDatabaseConnection {
        data = typeof data === 'object' ? data : {};
        let result = new MySqlDatabaseConnection();
        result.init(data);
        return result;
...
export class MariaDbDatabaseConnection extends EntityFrameworkDatabaseConnection implements IMariaDbDatabaseConnection {
    ...
    static override fromJS(data: any): MariaDbDatabaseConnection {
        data = typeof data === 'object' ? data : {};
        let result = new MariaDbDatabaseConnection();
        result.init(data);
        return result;
